...
private void undoOperation(String id) {
    if (repository.existsById(id)) {
        repository.deleteById(id); // Borramos de Mongo (o del Set)
        System.out.println("🗑️ Operación " + id + " deshecha. Recursos liberados.");
    } else {
        System.out.println("No se encontró nada que deshacer para ID: " + id);
    }
}
}